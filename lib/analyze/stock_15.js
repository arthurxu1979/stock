var Analyze_15 = function () {
    this.next_day = 10;
    this.duration = 15;
};

Analyze_15.prototype.getList = function (stocks) {
...
Analyze_15.prototype.getMPList = function(stocks) {
    var stock5Day = null;
...
Analyze_15.prototype.getCollection = function () {
    return 'stocks_15';
};

Analyze_15.prototype.mapAll = function(stockList, stockDays) {
    var results = [];
    var max_dist = 80;
    var self = this;
